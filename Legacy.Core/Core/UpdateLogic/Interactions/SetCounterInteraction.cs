...
{
	public class SetCounterInteraction : BaseInteraction
	{
		public const Int32 PARAM_COUNT = 1;

		private Int32 m_newValue;

		protected CounterObject m_interactiveObject;

		protected InteractiveObject m_parent;

		public SetCounterInteraction()
		{
		}

		public SetCounterInteraction(SpawnCommand p_command, Int32 p_parentID, Int32 p_commandIndex) : base(p_command, p_parentID, p_commandIndex)
		{
		...
		protected override void ParseExtra(String p_extra)
		{
			...
			m_newValue = Convert.ToInt32(array[0]);
		}

		protected override void DoExecute()
		{
			m_interactiveObject.SetCounter(m_newValue);
			FinishExecution();
		}
