...
{
	public class GameOverInteraction : BaseInteraction
	{
		...
		public GameOverInteraction(SpawnCommand p_command, Int32 p_parentID, Int32 p_commandIndex) : base(p_command, p_parentID, p_commandIndex)
		{
		...
		{
			Thread.Sleep((Int32)(m_messageDelay * 1000f));
			LegacyLogic.Instance.EventManager.InvokeEvent(this, EEventType.GAME_OVER, EventArgs.Empty);
		}
	}
}
