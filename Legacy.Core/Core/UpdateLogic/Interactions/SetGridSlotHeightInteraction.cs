...
{
	public class SetGridSlotHeightInteraction : BaseInteraction
	{
		...
		public SetGridSlotHeightInteraction()
		{
		}

		public SetGridSlotHeightInteraction(SpawnCommand p_command, Int32 p_parentID, Int32 p_commandIndex) : base(p_command, p_parentID, p_commandIndex)
		{
		...
		protected override void ParseExtra(String p_extra)
		{
			...
			Single.TryParse(array[2], out m_newHeight);
		}
	}
}
