...
{
	public class VeilOfConfusionTrapEffect : DamageDealingTrapEffect
	{
		public VeilOfConfusionTrapEffect(Int32 p_staticID, InteractiveObject p_parent) : base(p_staticID, p_parent)
		{
		}
