...
namespace Legacy.MSBuild
{
    public class Deploy : ITask
    {
        ...
        private sealed class FileCopier
        {
            ...
            private FileCopier(Deploy deployTask, String assemblyDirectory)
            {
                _deployTask = deployTask;
                ...
                {
                    _targetPath = Path.Combine(assemblyDirectory, _deployTask.TargetName);
            ...
            public static FileCopier TryGetFileCopier(Deploy deployTask)
            {
                try
                {
                    ...
                    if (Directory.Exists(gameLocation.ManagedPath))
                        return new FileCopier(deployTask, gameLocation.ManagedPath);
            ...
            private void BeginCopy(String extension, Boolean logSuccess)
            {
                ...
                if (_targetPath != null)
                {
                    String targetItem = _targetPath + extension;
