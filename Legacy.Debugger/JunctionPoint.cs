...
namespace Legacy.Debugger
{
    ...
    public static class JunctionPoint
    {
        ...
        public static void Create(String junctionPoint, String targetDir, Boolean overwrite)
        {
            ...
            using (SafeFileHandle handle = OpenReparsePoint(junctionPoint, EFileAccess.GenericWrite))
            {
                ...
                try
                {
                    ...
                    Int32 bytesReturned;
                    Boolean result = DeviceIoControl(handle.DangerousGetHandle(), FSCTL_SET_REPARSE_POINT,
        ...
        public static void Delete(String junctionPoint)
        {
            ...
            using (SafeFileHandle handle = OpenReparsePoint(junctionPoint, EFileAccess.GenericWrite))
            {
                ...
                try
                {
                    ...
                    Int32 bytesReturned;
                    Boolean result = DeviceIoControl(handle.DangerousGetHandle(), FSCTL_DELETE_REPARSE_POINT,
        ...
        private static String InternalGetTarget(SafeFileHandle handle)
        {
            ...
            {
                Int32 bytesReturned;
                Boolean result = DeviceIoControl(handle.DangerousGetHandle(), FSCTL_GET_REPARSE_POINT,
